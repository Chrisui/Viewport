...
/**
 * Set current bounds (ie. copy off bounds object into this object)
 */
Bounds.prototype.setBounds = function(bounds) {
    this.pos.copy(bounds.pos);
 ...
 * @param {true} [contained] Shall we make sure the bounds are entirely in range?
 * @return {Boolean}
 */
