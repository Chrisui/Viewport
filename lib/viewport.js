 ...
 * @augments Bounds
 */
var Viewport = Bounds.extendWithConstructor(function(pos, size, viewBounds, options) {
    // Call super
 ...
 * @param {Victor|true} [viewPlotOriginOrAbsolute] If true then we'll assume we don't care about an origin (ie. range position/offset)
 * @return {Victor}
 */
